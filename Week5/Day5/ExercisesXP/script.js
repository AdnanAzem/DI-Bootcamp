...
// Function to render robots
function renderRobots(filteredRobots) {
  robotContainer.innerHTML = ''; // Clear previous cards
...
// Initial rendering of all robots
renderRobots(robots);
